    ...
    func didUpdatePageInfoFinish(success: Bool) {
        if success {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
                ProfileOpener.openProfileDetail(.page, castcleId: nil, displayName: "", page: Page().initCustom(id: "", displayName: self.viewModel.pageRequest.displayName, castcleId: self.viewModel.pageRequest.castcleId, avatar: "", cover: "", overview: "", official: false))
            }
        }
    }
}
