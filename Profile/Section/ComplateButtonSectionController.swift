...
extension ComplateButtonSectionController {
    ...
    override func cellForItem(at index: Int) -> UICollectionViewCell {
        let cell = collectionContext?.dequeueReusableCell(withNibName: ProfileNibVars.CollectionViewCell.complateButton, bundle: ConfigBundle.profile, for: self, at: index) ?? ComplateButtonCell()
